module Scene_Db_Battle_Anime_attack_start
    ...
    def attack_start()
        ...
        if @attackDir == 0  # L -> R
            if attackPattern < 11  # normal attack
                # 対象攻撃を格納
        ...
        begin
                        ...
                        when 0  # Z1
                            ...
                            when 14 # 太陽拳  (xsin)
                                if @battle_anime_result == 0
                                    ...
                                    #必殺技発動
                                    @battle_anime_result = anime_pattern(2193)
                                elsif @battle_anime_result == 3
                                    #光線系ダメージ
                                    damage_pattern = 25
                                    attackAnimeEnd = true
                            ...
                            when 26 #陨石连击(悟空)  (xsin)
                                if @battle_anime_result == 0
                                    ...
                                    #必殺技発動
                                    @battle_anime_result = anime_pattern(4692)
                                elsif @battle_anime_result == 3
                                    #光線系ダメージ
                            ...
                            when 976 #蛇姬 撞击 (xsin)
                                ...
                                if @battle_anime_result == 0
                                    ...
                                    #必殺技発動
                                    @battle_anime_result = anime_pattern(976)
                                elsif @battle_anime_result == 3
                                    #光線系ダメージ
                                    damage_pattern = 43
                                    attackAnimeEnd = true
                            ...
                            when 620 #連続強力エネルギー波(サンショ系) (xsin)
                                #@tec_back_small = true
                                if @all_attack_count >= 2 && @battle_anime_result == 0
                                    @chr_cutin_flag = true
                                    @battle_anime_result = 2
           ...
           #必殺技発動
           @battle_anime_result = anime_pattern(1194)
       elsif @battle_anime_result == 3
           #光線系ダメージ
           damage_pattern = 25
           attackAnimeEnd = true
                 ...
                 when 27 #超级冲击波Z2
                     if @battle_anime_result == 0
                         ...
                         #必殺技発動
                         @battle_anime_result = anime_pattern(4475)
                     elsif @battle_anime_result == 3
                         #光線系ダメージ
                         damage_pattern = 43
                         attackAnimeEnd = true
            ...
            if @battle_anime_result == 0
                ...
                #必殺技発動
                @battle_anime_result = anime_pattern(1137)
            elsif @battle_anime_result == 3
                #光線系ダメージ
                damage_pattern = 23
                attackAnimeEnd = true
          ...
          when 60 #超魔弹
              if @battle_anime_result == 0
                  ...
                  @battle_anime_result = anime_pattern(31)
                   ...
                   #必殺技発動
                   @battle_anime_result = anime_pattern(4676)
               elsif @battle_anime_result == 3
                   #光線系ダメージ
                   damage_pattern = 23
                   attackAnimeEnd = true
       ...
       when 66 #複数エネルギー波  SGOHAN
           ...
           if @battle_anime_result == 0
               ...
               #必殺技発動
               @battle_anime_result = anime_pattern(4658)
           elsif @battle_anime_result == 3
               #光線系ダメージ
               damage_pattern = 23
               attackAnimeEnd = true
             ...
             #必殺技発動
             @battle_anime_result = anime_pattern(1195)
         elsif @battle_anime_result == 3
             #光線系ダメージ
             damage_pattern = 25
             attackAnimeEnd = true
               ...
               when 120 #剑气波 弥次郎兵卫
                   ...
                   if @battle_anime_result == 0
                       ...
                       #必殺技発動
                       @battle_anime_result = anime_pattern(4683)
                   elsif @battle_anime_result == 3
                       #光線系ダメージ
                       damage_pattern = 23
                       attackAnimeEnd = true
               ...
               when 142 #超级ギャリック砲
                   if @battle_anime_result == 0
                       ...
                       #必殺技発動
                       @battle_anime_result = anime_pattern(4476)
                   elsif @battle_anime_result == 3
                       #光線系ダメージ
                       damage_pattern = 41
                       attackAnimeEnd = true
    ...
    when 402, 407, 575, 587 #フリーザ超能力(全体),ライチー
        ...
        if @battle_anime_result == 0
            ...
            attackAnimeEnd = true
             ...
             when 468  #(フリーザG 弗利萨G)エネルギー波
                 if @battle_anime_result == 0
                     ...
                     #必殺技発動
                     @battle_anime_result = anime_pattern(4338)
                 elsif @battle_anime_result == 3
                     #光線系ダメージ
                     damage_pattern = 23
                     attackAnimeEnd = true
                ...
                when 979   #(超ベジータ)スーパーギャリック砲超级穿击炮
                    if @battle_anime_result == 0
                        #上から左下に移動
                        @battle_anime_result = anime_pattern(31)
                    elsif @battle_anime_result == 1
         ...
         if @battle_anime_result == 0
             ...
             when 14 #太陽拳(Z3テンシンハン)太阳拳Z3 天津饭
                 if @battle_anime_result == 0
                     #上から左下に移動
                     @battle_anime_result = anime_pattern(31)
          elsif @battle_anime_result == 1
              ...
              #必殺技発動
              @battle_anime_result = anime_pattern(2191)
          elsif @battle_anime_result == 3
              #光線系ダメージ
              damage_pattern = 76
              attackAnimeEnd = true
                ...
                when 24 #気円斬
                    if @battle_anime_result == 0
                        ...
                        #必殺技発動
                        @battle_anime_result = anime_pattern(4294)
                    elsif @battle_anime_result == 3
                        #光線系ダメージ
                        damage_pattern = 41
                        attackAnimeEnd = true
              ...
              when 32 #气合炮S GOKU
                  if @battle_anime_result == 0
                      ...
                      #必殺技発動
                      @battle_anime_result = anime_pattern(4201)
                  elsif @battle_anime_result == 3
                      #衝撃波系ダメージ
                      damage_pattern = 22
                      attackAnimeEnd = true
                ...
                when 33 #超气功波S GOKU
                    if @battle_anime_result == 0
                        ...
                        #必殺技発動
                        @battle_anime_result = anime_pattern(4675)
                    elsif @battle_anime_result == 3
                        #光線系ダメージ
                        damage_pattern = 41
                        attackAnimeEnd = true
          ...
          when 34 #连气弹
              ...
              if @battle_anime_result == 0
                  ...
                  #必殺技発動
                  @battle_anime_result = anime_pattern(4163)
              elsif @battle_anime_result == 3
                  #光線系ダメージ
                  damage_pattern = 24
                  attackAnimeEnd = true
      ...
      #必殺技発動
      @battle_anime_result = anime_pattern(2190)
  elsif @battle_anime_result == 3
      #光線系ダメージ
      damage_pattern = 76
      attackAnimeEnd = true
         ...
         if @battle_anime_result == 0
             ...
             @battle_anime_result = anime_pattern(31)
                 ...
                 #必殺技発動
                 @battle_anime_result = anime_pattern(1208)  #1204
             elsif @battle_anime_result == 3
                 #光線系ダメージ
                 damage_pattern = 41
                 attackAnimeEnd = true
      ...
      when 48 #魔空波
          ...
          if @battle_anime_result == 0
              ...
              #必殺技発動
              @battle_anime_result = anime_pattern(4682)
          elsif @battle_anime_result == 3
              #光線系ダメージ
              damage_pattern = 41
              attackAnimeEnd = true
      ...
      when 51 #FP魔貫光殺砲(ピッコロ)
          if @battle_anime_result == 0
              ...
              #必殺技発動
              @battle_anime_result = anime_pattern(2137)
          elsif @battle_anime_result == 3
              #光線系ダメージ
              damage_pattern = 41
              attackAnimeEnd = true
           ...
           if @battle_anime_result == 0
             ...
             when 59 #爆砕魔弾(悟飯)
              ...
              #必殺技発動
              @battle_anime_result = anime_pattern(1210) #1208  #1204
          elsif @battle_anime_result == 3
              #光線系ダメージ
              damage_pattern = 41
              attackAnimeEnd = true
              ...
              if @battle_anime_result == 0
               ...
               when 76 #MAXPOWER カメハメ波(クリリン)
                   ...
                   if @battle_anime_result == 0
                       ...
                       #必殺技発動
                       @battle_anime_result = anime_pattern(4677) #2163
                   elsif @battle_anime_result == 3
                       #光線系ダメージ
                       damage_pattern = 24
                       attackAnimeEnd = true
        ...
        when 77 #太阳拳 Z3小林
            if @battle_anime_result == 0
              ...
              #必殺技発動
              @battle_anime_result = anime_pattern(2189)
          elsif @battle_anime_result == 3
              #光線系ダメージ
              damage_pattern = 76
              attackAnimeEnd = true
                            ...
                            when 82 # カメハメ波(ヤムチャ)
                                if @battle_anime_result == 0
                                    ...
                                    # 必殺技発動
                                    @battle_anime_result = anime_pattern(1175)
                                elsif @battle_anime_result == 3
                                    # 光線系ダメージ
                                    damage_pattern = 23
                                    attackAnimeEnd = true
               ...
               when 86 #究极狼牙風風拳(ヤムチャ)
                   if @battle_anime_result == 0
                       ...
                       #必殺技発動
                       @battle_anime_result = anime_pattern(4342)
                   elsif @battle_anime_result == 3
                       #光線系ダメージ
                       damage_pattern = 43
                       attackAnimeEnd = true
         ...
         when 87 #ダブル繰気弾 DOUBLE  (ヤムチャ)
             if @battle_anime_result == 0
                 ...
                 #必殺技発動
                 @battle_anime_result = anime_pattern(4416)
             elsif @battle_anime_result == 3
                 #光線系ダメージ
                 damage_pattern = 23
                 attackAnimeEnd = true
                 ...
                 when 96 #真太阳拳(テンシンハン)
                     ...
                     if @battle_anime_result == 0
                         ...
                         #必殺技発動
                         @battle_anime_result = anime_pattern(2196)
                     elsif @battle_anime_result == 3
                         #光線系ダメージ
                         damage_pattern = 47
                         attackAnimeEnd = true
          ...
          when 97 #百万気功砲(テンシンハン)
              ...
              if @battle_anime_result == 0
                  ...
                  #必殺技発動
                  @battle_anime_result = anime_pattern(4678) #2163
              elsif @battle_anime_result == 3
                  #光線系ダメージ
                  damage_pattern = 24
                  attackAnimeEnd = true
          ...
          when 106 #PSYCHO BEAM
              ...
              if @battle_anime_result == 0
                  ...
                  #必殺技発動
                  @battle_anime_result = anime_pattern(4680)
              elsif @battle_anime_result == 3
                  #光線系ダメージ
                  damage_pattern = 23
                  attackAnimeEnd = true
           ...
           when 107 #自爆 饺子
               if @battle_anime_result == 0
                   ...
                   #必殺技発動
                   @chr_cutin_flag = true
                   @battle_anime_result = anime_pattern(4681) #193
               elsif @battle_anime_result == 3
                   #光線系ダメージ
                   damage_pattern = 23
                   attackAnimeEnd = true
               ...
               when 136 #衝撃波(ベジータ) 粉碎指
                   if @battle_anime_result == 0
                       ...
                       #必殺技発動
                       @battle_anime_result = anime_pattern(4101)
                   elsif @battle_anime_result == 3
                       #衝撃波系ダメージ
                       damage_pattern = 22
                       attackAnimeEnd = true
            ...
            when 137 #ギガブラスター(ベジータ)
                if @battle_anime_result == 0
                    ...
                    #必殺技発動
                    @battle_anime_result = anime_pattern(2228)
                elsif @battle_anime_result == 3
                    #光線系ダメージ
                    damage_pattern = 42
                    attackAnimeEnd = true
               ...
               when 138 #フォトンボンバー(ベジータ)
                   ...
                   if @battle_anime_result == 0
                       ...
                       #必殺技発動
                       @battle_anime_result = anime_pattern(4417)
                   elsif @battle_anime_result == 3
                       #光線系ダメージ
                       damage_pattern = 23
                       attackAnimeEnd = true
             ...
             when 139 #気円斬(ベジータ)
                 ...
                 if @battle_anime_result == 0
                     ...
                     #必殺技発動
                     @battle_anime_result = anime_pattern(4418)
                 elsif @battle_anime_result == 3
                     #光線系ダメージ
                     damage_pattern = 23
                     attackAnimeEnd = true
          ...
          when 54, 182, 417, 510 #カタナ攻撃(トランクス、サウザー、ゴクア)
              if @battle_anime_result == 0
                  # 上から左下に移動
                  @battle_anime_result = anime_pattern(31)
              elsif @battle_anime_result == 1
              ...
              when 190    #ゴッドブレイカー GOD BREAKER
                  ...
                  if @battle_anime_result == 0
                    ...
                    #必殺技発動
                    @battle_anime_result = anime_pattern(4679)
                elsif @battle_anime_result == 3
                    #光線系ダメージ
                    damage_pattern = 41
                    attackAnimeEnd = true
              ...
              when 226 #FPヘルズフラッシュ(16号 HELL  地狱燃烧炮
                  if @all_attack_count >= 2 && @battle_anime_result == 0
                      @tec_output_back = false
                      @chr_cutin = true
                      @chr_cutin_flag = true
                  ...
                  if @battle_anime_result == 0
                      ...
                      #必殺技発動
                      @battle_anime_result = anime_pattern(2316)  #2316
                  elsif @battle_anime_result == 3
                      #光線系ダメージ
                      damage_pattern = 42
                      attackAnimeEnd = true
         ...
         when 228 #16号摔投
             if @battle_anime_result == 0
                 ...
                 #必殺技発動
                 @battle_anime_result = anime_pattern(5002)
             elsif @battle_anime_result == 3
                 #光線系ダメージ
                 damage_pattern = 71
                 attackAnimeEnd = true
         ...
         when 977 #拉蒂斯 贯光线 貫光線
             if @battle_anime_result == 0
                 ...
                 #必殺技発動
                 @battle_anime_result = anime_pattern(4431)
             elsif @battle_anime_result == 3
                 #光線系ダメージ
            ...
            when 982 # 拉蒂斯大招 ビッグバンアタック
                ...
                if @battle_anime_result == 0
                    ...
                    #必殺技発動
                    @battle_anime_result = anime_pattern(4537)
                elsif @battle_anime_result == 3
                    #光線系ダメージ
                    damage_pattern = 41
                    attackAnimeEnd = true
            ...
            when 983 #超级拉蒂斯大招
                if @battle_anime_result == 0
                    ...
                    #必殺技発動
                    @battle_anime_result = anime_pattern(4580)
                elsif @battle_anime_result == 3
                    #光線系ダメージ
                    damage_pattern = 42
                    attackAnimeEnd = true
              ...
              if @battle_anime_result == 0
                ...
                when 978 #拉蒂斯超赛
                    ...
                    if @battle_anime_result == 0
                        ...
                        #必殺技発動
                        @battle_anime_result = anime_pattern(3745)
                    elsif @battle_anime_result == 3
                        #光線系ダメージ
                        #damage_pattern = 26
                        attackAnimeEnd = true
          ...
          when 979   #(超ベジータ)スーパーギャリック砲超级穿击炮
           ...
           when 980 #死亡弹 通用合体13号)SSデッドリィボンバー
               if @battle_anime_result == 0
                   #上から左下に移動
                   @battle_anime_result = anime_pattern(31)
               elsif @battle_anime_result == 1
                   ...
                   #必殺技発動
                   @battle_anime_result = anime_pattern(4785)
               elsif @battle_anime_result == 3
                   #光線系ダメージ
                   damage_pattern = 41
                   attackAnimeEnd = true
          ...
          when 981 #爆発波(弗利萨
              ...
              if @battle_anime_result == 0
                  ...
                  #必殺技発動
                  @battle_anime_result = anime_pattern(4689)
              elsif @battle_anime_result == 3
                  #光線系ダメージ
                  damage_pattern = 23
                  attackAnimeEnd = true
